...
/**
 *
 * Created by jesusp on 13/02/17.
 */
public class RestClient {
    //private static final String BASE_URL = "http://192.168.1.100/";
    private static final String BASE_URL = "http://jesusp.alumno.club/";
    private static final int MAX_TIMEOUT = 10000;
    private static final int RETRIES = 3;
    private static final int TIMEOUT_BETWEEN_RETRIES = 5000;
    private static final String APIKEY = "noselodigasanadie";
    //El true es que acepta all
